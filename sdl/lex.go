...
// human-authored surface for Loom schemas. The compiled schema
// (loom/schema) remains the language-neutral interchange artifact; .loom
// files are what people read, review, and — from M3 on — write.
package sdl
