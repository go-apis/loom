...
| --- | --- | --- | --- | --- | --- |
| 1 | Lazy decode, @retired events, and Migrate guards against undeclared log types | evaluating | mesh/loom-runners-fail-loud-1 | — | $4.78 |
...
| 4 | loom.CloudLogHandler — severity for Cloud Logging | running | — | — | $1.50 |
